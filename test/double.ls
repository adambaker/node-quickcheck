...
describe 'arbDouble', !->
  ...
  describe 'defaults' !->
    ...
    test 'should first yield 100 and -100' !->
    ...
    test 'should not generate infinites or NaN' !->
      for i from 1 to 100
        x = @doubles!
        assert isFinite(x)

  describe 'options' !->
    test 'should accept new max and min values' !->
    ...
    test 'should add NaN after max, min, and zero with includeNaN' !->
      doubles = arbDouble {include-NaN: true}
      doubles!; doubles!; doubles!
      assert isItNaN doubles!, 'NaN'

    test 'should add infinites after with includeInfinites' !->
    ...
    test 'should not include zero if that is suppressed.' !->
